...
# Inicializar la fuente de texto
pygame.font.init()
...
# Naves enemigas
RED_SPACE_SHIP = pygame.image.load(os.path.join("assets", "l_red.png"))
BLUE_SPACE_SHIP = pygame.image.load(os.path.join("assets", "l_blue.png"))
GREEN_SPACE_SHIP = pygame.image.load(os.path.join("assets", "l_green.png"))

# Nave del jugador
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("assets", "l_yellow.png"))
